...
// Prefferd for
const prefferedForFilter = async (req, res) => {
  //   const { gender } = req.body
  const prefference = 'Professional'; // Remove this line at the end and uncomment above line
  const genderFirst = prefference.charAt(0).toUpperCase();
...
module.exports = { genderFilter, prefferedForFilter, roomTypeFilter };
